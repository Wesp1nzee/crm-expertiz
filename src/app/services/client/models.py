...
class Client(Base):
    ...
    name: Mapped[str] = mapped_column(String(255), nullable=False, index=True)  # Полное наименование клиента
    short_name: Mapped[str | None] = mapped_column(String(100))  # Сокращённое наименование клиента
