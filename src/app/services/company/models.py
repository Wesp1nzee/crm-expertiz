...
from sqlalchemy import UUID, Boolean, DateTime, Numeric, String, func
...
class Company(Base):
    ...
    balance: Mapped[Decimal] = mapped_column(
        Numeric(precision=15, scale=2), default=Decimal("0.00"), server_default="0.00", comment="Текущий баланс компании на счету"
    )
    ...
    users: Mapped[list[User]] = relationship("User", back_populates="company", cascade="all, delete-orphan", passive_deletes=True)
